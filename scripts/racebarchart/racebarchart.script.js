export default function define(runtime, observer) {
  ...
  main.define("data attechment", ["FileAttachment"], function (FileAttachment) {
    let data = FileAttachment("dataset.csv").csv({ typed: true });
    return data;
  });
  main.define("data", ["data attechment"], function (data) {
  ...
  main.define("tickFormat", function () {
    return undefined;
  });
  main.define(
    "axis",
    ["margin", "d3", "x", "width", "tickFormat", "barSize", "n", "y"],
    function (margin, d3, x, width, tickFormat, barSize, n, y) {
